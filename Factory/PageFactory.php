 ...
 */
namespace Presta\CMSSandboxBundle\Factory;
...
class PageFactory extends BasePageFactory implements ModelFactoryInterface
{
    ...
    protected function configureZones(array $page)
    {
        ...
        if (count($page['children']) > 1) {
            $page['zones']['content']['blocks'][20] = array(
                'name' => 'children',
                ...
                if ($block['name'] == 'info') {
                    $block['settings'] = array(
                        ...
                        'fr' => array(
                            'title' => '',
                            'block_style' => 'info',
                            'content' => 'Ceci est une démonstration.<br/>'
                                . 'Le contenu du site est remis à jour toutes les 2 heures.'
                        )
                    );
                    ...
                    $block['settings'] = array(
                        'en' => array(
                            'title' => 'Need help ?',
                            'block_style' => 'info',
                            'content' => 'If you need help or want to have some news about PrestaCMS development,'
                                . ' please register to our <br/><a class="btn link" href="https://groups.google.com'
                                . '/forum/?hl=fr&fromgroups#!forum/prestacms-devs"><i class="icon-question-sign"></i>'
                                . '&nbsp;Google group</a>.'
                        ),
                        'fr' => array(
                            'title' => 'Besoin d\'aide ?',
                            'block_style' => 'info',
                            'content' => 'Si vous avez des questions ou que vous voulez être au courant du '
                                . 'développement de PrestaCMS, abonner vous à notre <br/><a class="btn link" '
                                . 'href="https://groups.google.com/forum/?hl=fr&fromgroups#!forum/prestacms-devs">'
                    ...
                    $block['settings'] = array(
                        'en' => array(
                            ...
                            'content' => 'Discover PrestaCMS backend based on SonataAdmin to easily administrate '
                                . 'your website <br/><a class="btn link" href="/admin"><i class="icon-wrench"></i>'
                                . '&nbsp;Login</a>.'
                        ),
                        'fr' => array(
                            'title' => 'Administration',
                    ...
                    $block['settings'] = array(
                        'en' => array(
                            ...
                            'content' => 'This is your text. You can edit it in the administration with a WYSIWYG.'
                                . '<br/><br/>This content is translatable and has been loaded by PrestaCMS fixtures.'
                        ),
                        'fr' => array(
                            'title' => 'Exemple de bloc paragraphe',
                            'content' => 'Ce bloc est administrable dans le backoffice avec un éditeur WYSIWYG.<br/>'
            ...
            case 'presta_cms.block.page_children':
                $block['settings'] = array(
                    'en' => array(
                        ...
                        'content' => 'This block displays all page children, each child rendering can be customize by'
                            . 'taking advantage of the pages types possibilities.'
                    ),
                    'fr' => array(
                        'title' => 'Exemple de bloc page pallier',
                        'content' => 'Ce bloc vous permet de présenter la liste des pages enfants.<br/><br/>'
                            . 'Pour chacun d\'eux le bloc affiche son titre, sa description ainsi qu\'un lien '
                            . ' permettant d\'accéder à la page.'
                    )
                );
                break;
            ...
            case 'presta_cms.block.media_advanced':
                $block['settings'] = array(
                    ...
                    'fr' => array(
                        ...
                        'content' => 'Ce bloc vous permet d\'ajouter un média (image, viadeo... suivant votre '
                            . 'configuration projet) avec un titre et un contenu. Il est également possible de choisir'
                            . ' le style d\'affiche à l\'aide le l\'option "layout"',
                        'media' => 2,
                        'format' => 'prestacms_page_wide'
                    )
                );
